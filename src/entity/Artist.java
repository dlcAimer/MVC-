 ...
 */
@Entity
@Table(name = "artist", schema = "art", catalog = "")
public class Artist {
    ...
    public Artist(int artistId, String firstName, String lastName, String nationality, Integer yearOfBirth, Integer yearOfDeath, String details, String artistLink) {
        this.artistId = artistId;
