...
1. **Search for existing issues.** We get a lot of duplicate issues, and you'dao help us out a lot by first checking if someone else has reported the same issue. Moreover, the issue may have already been resolved with a fix available.
